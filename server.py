...
<script>
const token={token_json};const input=document.getElementById('photo');const cameraInput=document.getElementById('cameraPhoto');const preview=document.getElementById('preview');const send=document.getElementById('send');const status=document.getElementById('status');let photo='';
